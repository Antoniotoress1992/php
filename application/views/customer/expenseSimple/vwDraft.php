                                ...
                                <div class = "row">
                                    ...
                                    <div class = "col-sm-2">
                                        <div class="form-group">
                                            <label>Invoice #</label>
                                            <div class="input-icon">
                                                <input type="text" class="form-control" id = "invoice" value = "<?php echo $invoiceNumber;?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class = "col-sm-2">
                                ...
                                <div class="table-container" style = "margin-top:20px;" >
                                            ...
                                            <tbody id = "invoiceTbody">
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" id="itemDisForInvoice" onkeyup = "return changeQty(event,this)" <?php echo $discount;?>>
                                                    </td>
                                                    <td>
                                        ...
                                        <div class = "row">
                                            <div class = "col-sm-4">
                                                <?php $invoiceId = $_GET['invoiceId'];?>
                                                <button type="button" class="btn btn-primary" onclick = "updateInvoice(<?php echo $invoiceId;?>)">Save</button>
                                            </div>
