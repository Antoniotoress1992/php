                                ...
                                <div class="table-container" style = "margin-top:20px;" >
                                            ...
                                            <tbody id = "invoiceTbody">
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" id="itemDescriptionForInvoice">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" id="itemQtyForInvoice"  onkeyup="return changeQty(event,this)">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" id="itemUnitPriceForInvoice" onkeyup="return changeQty(event,this)">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" id="itemDisForInvoice" onkeyup = "return changeQty(event,this)">
                                                    </td>
                                                    <td>
                                                        <?php $preAccount = "" ; ?>
                                                    ...
                                                    <td>
                                                        <select class = "form-control" id = "itemTaxRateForInvoice" onchange = "changeQty(event , this)"/>
                                                            ...
                                                            <option value = "<?php echo $tax->id;?>" price = "<?php echo $tax->taxRate;?>"><?php echo $tax->name.' '.$tax->taxRate;?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" id="itemAmountForInvoice" disabled>
                                                    </td>
                                                    <td>
                                        ...
                                        <div class = "row">
                                            <div class="col-xs-4 invoice-block pull-right text-right">
                                                <ul class="list-unstyled amounts">
                                                    <li>
                                                        <strong>Sub - Total amount:</strong> <strong id = "subTotalAmount">$100</strong>
                                                    </li>
                                                    ...
                                                    <hr>
                                                    <li>
                                                        <strong>TOTAL:</strong> <strong id = "totalAmount">7.00</strong>
                                                    </li>
                                                    <hr>
                                        ...
                                        <div class = "row">
                                            ...
                                            <div class = "col-sm-4 text-right pull-right">
                                                <button type="button" class="btn green" onclick = "makeApprove()">Approve</button>
