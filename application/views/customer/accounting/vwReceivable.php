                ...
                <div class="row">
                    <div class="col-sm-12">
                                ...
                                <div class="table-container" style = "margin-top:20px;" >
                                            ...
                                            <tbody id = "invoiceTbody">
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    ?>
                                                    <td>
                                                        <input type = "hidden" id = "invoiceContentId" value = "<?php echo $purchaseContent->id;?>"/>
                                                        <?php echo $purchaseContent->itemName;?>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
														<?php echo $purchaseContent->accountName;?>
                                                     
                                                    </td>
                                                    <td>
														<?php echo $purchaseContent->taxName;?>
						...
						<div class = "portlet box blue">
							<div class = "portlet-title">
								 <div class="caption">
                                    <i class="fa fa-pencil-square-o"></i> Receive Payment
                                </div>
							</div>
							<div class = "portlet-body">
								 <div class = "row">
                                    <div class = "col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-icon">
                                                ...
                                                <input type="text" class="form-control" id = "amountPaid" value = "<?php echo $subTax + $totalAmount; ?>" >
                                        </div>
                                    </div>
                                    <div class = "col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-icon">
                                                <input type="text" class="form-control" id = "datePaid" value = "">
                                            </div>
                                        </div>
                                    </div>
                                    <div class = "col-sm-2">
                                        <div class="form-group">
											...
											<select class="form-control" id = "paidTo"> 
											  <option></option>
											  <?php foreach($paidTos as $paidTo){?>
											  <option value = "<?php echo $paidTo->id;?>"><?php echo $paidTo->name;?></option>
											  <?php } ?>
											</select>
                                    ...
                                    <div class = "col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-icon">
                                                <input type="text" class="form-control" id = "paidReference" value = "">
                                            </div>
                                        </div>
                                    </div>
                                    <div class = "col-sm-2 ">
										<button type="button" class="btn green" onclick = "savePayment(<?php echo $_GET['purchaseId'];?>)">Add a Payment</button>
									</div>
                                </div>
							</div>
						</div>
