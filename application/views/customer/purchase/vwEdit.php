                    ...
                    <div class="col-sm-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-pencil-square-o"></i> New Bill
                                </div>
                            </div>
                                        ...
                                        <div class = "row">
                                            <div class="col-xs-4 invoice-block pull-right text-right">
                                                <ul class="list-unstyled amounts">
                                                    <li>
                                                        <strong>Sub - Total amount:</strong> <strong id = "subTotalAmount">$0.0</strong>
                                                    </li>
                                                    ...
                                                    <hr>
                                                    <li>
                                                        <strong>TOTAL:</strong> <strong id = "totalAmount">0.0</strong>
                                                    </li>
                                                    <hr>
