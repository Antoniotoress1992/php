    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <?php 
                    $nameTo = $purchaseInv->contactName;                
                    $date = $purchaseInv->date;                
                    $dueDate = $purchaseInv->dueDate;                
                    $reference = $purchaseInv->reference;                
                    $currencyId = $purchaseInv->currencyId;                
                    ...
                    <div class="col-sm-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-pencil-square-o"></i> New Invoice
                                </div>
                            </div>
                            <div class="portlet-body">
                                ...
                                <div class = "row">
                                    <div class = "col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-icon">
                                                ...
                                                <input type="text" class="form-control" id = "toData" value = "<?php echo $nameTo;?>" >
                                        </div>
                                    </div>
                                    <div class = "col-sm-2">
                                        <div class="form-group">
                                    ...
                                    <div class = "col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-icon">
                                                <input type="text" class="form-control" id = "dueDate" value = "<?php echo $dueDate;?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class = "row">
                                    <div class = "col-sm-4">
                                        <select class="form-control" id = "currencySelect" onchange="changeCurrency()"> 
                                            ...
                                            <option value = "<?php echo $currency->id;?>" <?php if($currency->id == $currencyId ){echo 'selected';}?>><?php echo $currency->name;?></option>
											<?php }?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="table-container" style = "margin-top:20px;" >
                                            ...
                                            <tbody id = "invoiceTbody">
                                                <?php $totalAmount = 0 ;?>
                                                <?php foreach($purchaseContents as $purchaseContent){?> 
                                                <tr role="row" class="filter">
                                                    <?php 
                                                        $itemId = $purchaseContent->itemId;
                                                        $description = $purchaseContent->description;  
                                                        $qty = $purchaseContent->qty;
                                                        $unitPrice = $purchaseContent->unitPrice;
                                                        $accountId = $purchaseContent->accountId;
                                                        $taxRateId = $purchaseContent->taxRateId;
                                                        $amount = $purchaseContent->amount;

                                                        $totalAmount = $totalAmount + $amount * 1;
                                                    ?>
                                                    <td>
                                                        <input type = "hidden" id = "purchaseContentId" value = "<?php echo $purchaseContent->id;?>"/>
                                                        <select class="form-control" id = "item" onchange="changeItem(this)" style = "width:150px;"> 
                                                          <option></option>  
                                                          <option value="add">
                                                            + New Item
                                                          </option>
                                                          <?php foreach($items as $item){?>
                                                          <option value = "<?php echo $item->id;?>" <?php if($item->id == $itemId){echo 'selected';} ?>><?php echo $item->itemName;?></option>
                                                          <?php } ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" id="itemDescriptionForInvoice" value = "<?php echo $description;?>">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" id="itemQtyForInvoice"  onkeyup="return changeQty(event,this)" value ="<?php echo $qty; ?>">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" id="itemUnitPriceForInvoice" onkeyup="return changeQty(event,this)" value="<?php echo $unitPrice;?>">
                                                    </td>
                                                   
                                                    <td>
                                                        <select class = "form-control" id = "itemAccountForInvoice" onchange = "changeAccount(this)">
                                                            <option></option>
                                                            <option value = "add">Add New Account</option>
                                                            <?php foreach($accounts as $account){?>
                                                                <option value = "<?php echo $account->id;?>" <?php if($account->id == $accountId){echo 'selected';}?>><?php echo $account->accountName;?></option>
                                                            <?php } ?>

                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select class = "form-control" id = "itemTaxRateForInvoice" onchange = "changeQty(event , this)"/>
                                                            <option></option>
                                                            <?php foreach($taxes as $tax){?>
                                                            <option value = "<?php echo $tax->id;?>" price = "<?php echo $tax->taxRate;?>" <?php if($tax->id == $taxRateId){echo 'selected';}?>><?php echo $tax->name.' '.$tax->taxRate;?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" id="itemAmountForInvoice" disabled value = "<?php echo $amount;?>">
                                                    </td>
                                                    <td>
                                        ...
                                        <div class = "row">
                                            <div class="col-xs-4 invoice-block pull-right text-right">
                                                <ul class="list-unstyled amounts">
                                                    ...
                                                    <?php foreach($purchaseContents as $purchaseContent){?>
                                                    <?php if($purchaseContent->taxRate*1 != 0){?> 
                                                    <li id = "totalTaxDiv" style = "">
                                                        <strong >Total Tax <?php echo $purchaseContent->taxRate;?>%:</strong> <strong id = "totalTax"><?php echo $purchaseContent->amount*$purchaseContent->taxRate/100;$subTax = $purchaseContent->amount*$purchaseContent->taxRate/100 + $subTax;?></strong>
                                                    </li>
                                                    <?php } }?>
                                                    <hr>
                                                    <li>
                                        ...
                                        <div class = "row">
                                            <div class = "col-sm-4">
                                                ...
                                                <button type="button" class="btn btn-primary" onclick = "updatePurchase(<?php echo $purchaseId;?>)">Save</button>
                                            </div>
...
<?php $this->load->view('js/purchase/jsPurchase'); ?>
...
$( document ).ready(function() {
    ...
    <?php foreach($contacts as $contact){?>
        contacts[contacts.length] = "<?php echo $contact->name;?>";
    <?php } ?>    
