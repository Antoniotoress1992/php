                        ...
                        <div class="portlet box blue">
							...
							<ul class="nav nav-tabs">
								...
								<li class="<?php if($status == "All"){echo 'active';}?>">
									<a href="/customer/purchase/search?state=All" >
									All </a>
								</li>
								<li class="<?php if($status == "authorized"){echo 'active';}?>">
									<a href="/customer/purchase/search?state=authorized" >
									Awaiting Payment </a>
								</li>
								...
								<div class="table-container" style = "margin-top:20px;" >
                                            ...
                                            <tbody id = "invoiceTbody">
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <?php echo $purchase->paidReference;?>
                                                    </td>
                                                    <td>
                                                       
														<?php echo $purchase->paidTo; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $purchase->datePaid;?>
                                                    </td>
													<td>
                                                        <?php echo $purchase->dueDate;?>
                                                    </td>
                                                    <td>
                                                        <?php echo $purchase->amountPaid;?>
                                                    </td>
                                                    <td>
														<?php echo $purchase->state;?>
