    ...
    <main style="background: url(/assets/images/how_it_works_background.jpg); background-size: cover;">
        <div class="container" style="font-family: 'Bitter';">
            ...
            <div class="row padding-top-50">
                ...
                <div class="col-sm-7">
                    <h2 class="color-blue">Kick Off</h2>
                    <p class="font-droid">Download our mobile app for use</p>
                    <p class="font-droid">our Web System to get started</p>
                </div>
            </div>
            ...
            <div class="row margin-top-20">
                ...
                <div class="col-sm-7">
                    <h2 class="color-blue">Choose the lucky recipient</h2>
                    <p class="font-droid">Putting the information of the beloved you would like to give</p>
                    <p class="font-droid">gift for in the system. Decide the value size of the gift to pool</p>
                    <p class="font-droid">the money.</p>
                </div>
            </div>
