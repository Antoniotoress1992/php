        ...
        <div class="container" style="min-height: 500px;">
            <div class="row">
                ...
                <div class="col-sm-9 text-center">
                    ...
                    <div class="row">
                        <form method="POST" action="<?php echo base_url();?>business/widget/update" class="form-horizontal margin-top-30" role="form">
                            <?php
                                ...
                                <div class="col-sm-6">
                                    <?php if ($key == 'w_color' || $key == 'w_background') {?>
                                        <div class="input-group" id="js-div-<?php echo $key;?>">
                                            <input type="text" value="<?php echo set_value($key, isset($company->{$key}) ? $company->{$key} : ''); ?>" class="form-control" />
